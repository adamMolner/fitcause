...
<div class="container brands">
    <div class="row">
        ...
        <div class="col-md brand">
            ...
            <div class="btn-group">
                <a href="facetemplate.php?id=2" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Learn More</button></a> 
            </div>
        </div>
        <div class="col-md brand">
            ...
            <div class="btn-group">
                <a href="facetemplate.php?id=3" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Learn More</button></a>
            </div>
        </div>
    </div> <!-- End of row-->
    ...
    <div class="row">
            <div class="col-md brand">
                ...
                <div class="btn-group">
                    <a href="facetemplate.php?id=4" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Learn More</button></a> 
                </div>
            </div>
            <div class="col-md brand">
                ...
                <div class="btn-group">
                    <a href="facetemplate.php?id=5" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Learn More</button></a> 
                </div>
            </div>
            <div class="col-md brand">
            </div>
